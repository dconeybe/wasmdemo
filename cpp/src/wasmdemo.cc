...
void myMemcpy(void* dst, const void* src, const unsigned long size) {
...
void myMemset(void* dst, int value, unsigned long count) {
  char* d = static_cast<char*>(dst);
...
WASM_EXPORT("hash")
void hash(const char *str, const unsigned long size, unsigned char outputHash[16]) {
